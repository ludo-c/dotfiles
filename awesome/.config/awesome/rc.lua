...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "F2", function () awful.util.spawn("qdbus org.mpris.clementine /Player org.freedesktop.MediaPlayer.Pause") end),
    awful.key({ modkey,           }, "F4", function () awful.util.spawn("qdbus org.mpris.clementine /Player org.freedesktop.MediaPlayer.Next") end),
