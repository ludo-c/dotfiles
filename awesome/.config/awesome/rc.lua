...
function update_eths()
	...
	awful.spawn.easy_async_with_shell("LANG=C ip addr show | awk '/inet.*(brd|peer|tun|wg)/{print $NF}'", function(stdout)
...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioPrev", function () awful.spawn("qdbus org.mpris.MediaPlayer2.strawberry /org/mpris/MediaPlayer2 org.mpris.MediaPlayer2.Player.Previous") end),
...
run_once2({"flatpak run org.localsend.localsend_app"})
